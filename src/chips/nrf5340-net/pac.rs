...
pub mod radio {
    ...
    pub mod vals {
        ...
        impl Txpower {
            ...
            #[doc = "-7 dBm."]
            pub const Neg7dBm: Self = Self(0xf9);
            #[doc = "-6 dBm."]
            pub const Neg6dBm: Self = Self(0xfa);
            #[doc = "-5 dBm."]
            pub const Neg5dBm: Self = Self(0xfb);
            #[doc = "-4 dBm."]
            pub const Neg4dBm: Self = Self(0xfc);
            #[doc = "-3 dBm."]
            pub const Neg3dBm: Self = Self(0xfd);
            #[doc = "-2 dBm."]
            pub const Neg2dBm: Self = Self(0xfe);
            #[doc = "-1 dBm."]
            pub const Neg1dBm: Self = Self(0xff);
        }
        impl Txpower {
        ...
        impl core::fmt::Debug for Txpower {
            fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
                match self.0 {
                    ...
                    0xf9 => f.write_str("Neg7dBm"),
                    0xfa => f.write_str("Neg6dBm"),
                    0xfb => f.write_str("Neg5dBm"),
                    0xfc => f.write_str("Neg4dBm"),
                    0xfd => f.write_str("Neg3dBm"),
                    0xfe => f.write_str("Neg2dBm"),
                    0xff => f.write_str("Neg1dBm"),
                    other => core::write!(f, "0x{:02X}", other),
                }
            }
        }
        ...
        impl defmt::Format for Txpower {
            fn format(&self, f: defmt::Formatter) {
                match self.0 {
                    ...
                    0xf9 => defmt::write!(f, "Neg7dBm"),
                    0xfa => defmt::write!(f, "Neg6dBm"),
                    0xfb => defmt::write!(f, "Neg5dBm"),
                    0xfc => defmt::write!(f, "Neg4dBm"),
                    0xfd => defmt::write!(f, "Neg3dBm"),
                    0xfe => defmt::write!(f, "Neg2dBm"),
                    0xff => defmt::write!(f, "Neg1dBm"),
                    other => defmt::write!(f, "0x{:02X}", other),
                }
            }
        }
